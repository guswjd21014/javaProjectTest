...
public class MutilChatClient extends Frame implements ActionListener, Runnable {
...
//		텍스트 필드와 전송 버튼에 ActionListener를 걸어준다.
	...
	public static void main(String[] args) {
		...
		MutilChatClient client = new MutilChatClient();
		
		try {
//			서버에 접속한다.
			client.socket = new Socket("192.168.7.254", 10004);
			client.message = "192.168.7.20 서버의 10005번 포트로 접속 시도<br>";
